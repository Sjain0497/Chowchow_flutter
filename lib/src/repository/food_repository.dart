...
Future<Stream<Food>> getTrendingFoods(Address address) async {
  Uri uri = Helper.getUri('chowchow/api/foods');
  ...
  print("trendingFood....$uri");
  try {
    final client = new http.Client();
    final streamedRest = await client.send(http.Request('get', uri));
    var streamedResponse = await client.send(http.Request('get', uri));

    var response = await http.Response.fromStream(streamedResponse);
    print("Res-Food..${response.body}");
...
Future<Stream<Food>> getOfferFoods(Address address) async {
  Uri uri = Helper.getUri('chowchow/api/offer');
...
Future<Stream<Food>> getFoodsByCategory(categoryId) async {
  Uri uri = Helper.getUri('chowchow/api/withrestsearch');
