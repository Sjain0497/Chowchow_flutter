...
class _FoodWidgetState extends StateMVC<FoodWidget> {
  ...
  Widget build(BuildContext context) {
    int foodQuantity = _con.quantity.toInt();
    //print("FoodImage...${(_con.food.name)}");
    return Scaffold(
      key: _con.scaffoldKey,
      body: _con.food == null || _con.food?.restaurant.image == null
                          ...
                          flexibleSpace: FlexibleSpaceBar(
                            ...
                            background: Hero(
                              ...
                              child: CachedNetworkImage(
                                fit: BoxFit.cover,
                                imageUrl: _con.food.restaurant.image.url,
