    ...
    return WillPopScope(
      child: Scaffold(
          ...
          body: _con.cartsNew.isEmpty
                          ...
                          Center(
                            child: SizedBox(
                              ...
                              child: FlatButton(
                                ...
                                shape: StadiumBorder(),
                                child: Text(S.of(context).my_orders,
              ...
              //               ),
              //             ),
              //            // Helper.getPrice(_con.subTotalNew, context, style: Theme.of(context).textTheme.subtitle1)
              //           ],
              //         ),
              //         // Row(
              //         //   children: <Widget>[
              ...
              //         // ),
              //         SizedBox(height: 3),
              //         // _con.payment.method == 'Cash On Delivery'
              //         //     ? SizedBox(height: 0)
              //         //     : Row(
              //         //   children: <Widget>[
              //         //     Expanded(
              ...
              //         //       ),
              //         //     ),
              //         //     Helper.getPrice(_con.cartsNew[0].food.restaurant.deliveryFee, context, style: Theme.of(context).textTheme.subtitle1)
              //         //   ],
              //         // ),
              //         SizedBox(height: 3),
              //         // Row(
              ...
              //         //     Expanded(
              //         //       child: Text(
              //         //         "${S.of(context).tax} (${_con.cartsNew[0].food.restaurant.defaultTax}%)",
              //         //         style: Theme.of(context).textTheme.bodyText1,
              //         //       ),
              //         //     ),
              //         //     Helper.getPrice(_con.taxAmountNew, context, style: Theme.of(context).textTheme.subtitle1)
              //         //   ],
              //         // ),
              //         Divider(height: 30),
              //         // Row(
              ...
              //         //       ),
              //         //     ),
              //         //     Helper.getPrice(_con.totalNew, context, style: Theme.of(context).textTheme.headline4)
              //         //   ],
              //         // ),
              //         SizedBox(height: 20),
              //         SizedBox(
