...
class FoodsCarouselItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    int foodDiscountPrice = food.discountPrice.toInt();
    int foodPrice = food.price.toInt();
    // print("TendingFoodImage...${food.image.url}");
    return InkWell(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      fit: BoxFit.cover,
                      imageUrl: food.restaurant.image.url,
                      ...
                      errorWidget: (context, url, error) =>
                          Image.network(food.restaurant.image.thumb),
                    ),
                  ),
                ),
              ),
